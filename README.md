...
| AUTH-008 | P0 | Session/guards | Attempt to open `/account-settings` or `/security-settings` while logged out. | User is redirected to auth flow and cannot access private content. | Manual (periodic) |
