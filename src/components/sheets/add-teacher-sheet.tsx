...
const AddTeacherSheet = ({ subject, state, grade, subjectId, studentName }: { subject: string; state: string; grade: string; subjectId: string; studentName: string }) => {
  return (
    <Sheet>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>
            Locate a {gradeLabel(parseInt(grade))} {subject} teacher to help teach {studentName}
          </SheetDescription>
        </SheetHeader>
