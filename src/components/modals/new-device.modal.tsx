  ...
  const rememberDeviceMutation = useRememberDevice({
    onSuccess: () => {
      localStorage.setItem(
        'AddedDeviceKey',
        localStorage.getItem('DeviceKey') || 'amplify-remembered',
      );
      setShow(false);
    },
  });
  ...
  return (
    ...
    >
      <DialogContent>
        ...
        <p>
          This will allow you to login to your account from this device without
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            onClick={async () => {
              try {
                await forgetDevice({
                  device: { id: localStorage.getItem('DeviceKey') || '' },
                });
              } catch {
